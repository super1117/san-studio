...
import com.pdk.re.specified.adapter.ShoppingCartAdapter;
import com.pdk.re.specified.constant.Constants;
import com.pdk.re.specified.models.CartModel;
...
public class CartActivity extends Activity implements View.OnClickListener,
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.tv_settlement) { //结算
            pay();
        } else if (id == R.id.cart_back) {
            finish();
        }
    }
